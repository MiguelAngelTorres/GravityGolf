...
public class EntityFactory extends Actor {
    ...
    public List<PlanetaEntity> createPlanets(World world) {
        ...
        if(level == 1) {
            ...
            planetaList.add(new PlanetaEntity(world, planetaTexture, new Vector2(0,35), 3));
            planetaList.add(new PlanetaEntity(world, planetaTexture, new Vector2(0,5), 3));
            planetaList.add(new PlanetaEntity(world, planetaTexture, new Vector2(0,20), 2));
        }
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        return planetaList;
    }
